...
export default function SettingsPage() {
  ...
  return (
    <div className="container mx-auto max-w-4xl md:px-4 md:py-6">
      {/* Header */}
      <div className="flex items-center mb-4 bg-gradient-to-r from-blue-50 to-blue-100 p-2 rounded-2xl shadow-sm">
        <Link
          href="/dashboard"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-3 md:py-2 border border-gray-300 rounded-lg md:rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-sm"
              ...
              <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {selectedBanks.map((bank) => (
                        <div
                          ...
                          className="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-3 py-2 rounded-full text-sm font-medium"
                        >
                ...
                <div className="relative">
                  ...
                  {showBankDropdown && bankSearchTerm && (
                    <div className="bank-dropdown absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg md:rounded-md shadow-lg max-h-60 overflow-auto">
                      {filteredBanks.length > 0 ? (
                        filteredBanks.map((bank) => (
                          <button
                            ...
                            className="w-full text-left px-3 py-3 md:py-2 hover:bg-blue-50 focus:bg-blue-50 focus:outline-none"
                          >
                        ...
                        <div className="px-3 py-3 md:py-2 text-gray-500 text-sm md:text-base">
                          No banks found
                        </div>
                      )}
                    </div>
              ...
              <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-6 border-t border-gray-200">
                <Link
                  href="/dashboard"
                  className="px-6 py-3 md:py-2 text-gray-700 bg-gray-100 rounded-lg md:rounded-md hover:bg-gray-200 transition-colors duration-200 text-center text-base md:text-sm"
                >
                  Cancel
                </Link>
                <button
                  ...
                  className="px-6 py-3 md:py-2 bg-blue-600 text-white rounded-lg md:rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 text-base md:text-sm"
                >
                  {isSubmitting ? (
